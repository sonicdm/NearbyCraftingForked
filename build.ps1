...
$Project = Join-Path $ProjectRoot "NearbyCraftingForked.csproj"
...
try {
    ...
    Copy-Item -LiteralPath $Dll -Destination (Join-Path $Dist "NearbyCraftingForked.dll") -Force
    Write-Host "DLL: $(Join-Path $Dist 'NearbyCraftingForked.dll')"
